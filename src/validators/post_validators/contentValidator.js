...
export function validContent(content, storeClient) {
  let enabled = storeClient.get(["feedSettings", "blackListSettings", "enabled"], Boolean);
  let blackList = (storeClient.get(["feedSettings", "blackListSettings", "list"], String)).split("*");
